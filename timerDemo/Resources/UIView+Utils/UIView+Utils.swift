...
extension UIColor {
    ...
    static let primaryGreenColor = #colorLiteral(red: 0.7490196078, green: 0.8274509804, blue: 0.1882352941, alpha: 1)
    static let primaryLightGreenColor = #colorLiteral(red: 0.5254901961, green: 0.6, blue: 0.337254902, alpha: 1)
    static let textDarGreyColor = #colorLiteral(red: 0.2666666667, green: 0.2666666667, blue: 0.2666666667, alpha: 1)
    static let textLightGreyColor = #colorLiteral(red: 0.5960784314, green: 0.6196078431, blue: 0.6941176471, alpha: 1)
    static let greyBackground = #colorLiteral(red: 0.9333333333, green: 0.9411764706, blue: 0.9529411765, alpha: 1)
    static let primaryDarkBlueColor = #colorLiteral(red: 0.2392156863, green: 0.5411764706, blue: 0.968627451, alpha: 1)
    static let primarylightBlueColor = #colorLiteral(red: 0.4078431373, green: 0.8705882353, blue: 0.9803921569, alpha: 1)
    static let primaryYellowColor = #colorLiteral(red: 0.9960784314, green: 0.9803921569, blue: 0.7529411765, alpha: 1)
    static let primaryBrownColor = #colorLiteral(red: 0.2509803922, green: 0.1176470588, blue: 0.1215686275, alpha: 1)
    static let primaryHeaderColor = #colorLiteral(red: 0.7490196078, green: 0.8274509804, blue: 0.1882352941, alpha: 1)
}
